...
import com.midoconline.app.MiDocOnlineAplication;
...
public class VolleyController extends Application {
    ...
    private VolleyController() {
        mRequestQueue = mRequestQueue != null ? mRequestQueue : Volley.newRequestQueue(MiDocOnlineAplication.getAppContext());
