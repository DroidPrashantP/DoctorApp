...
public class IncomeCallListenerService extends Service implements QBRTCClientSessionCallbacks {
    ...
    public void onCreate() {
        super.onCreate();
        QBSettings.getInstance().init(IncomeCallListenerService.this, Constants.APP_ID, Constants.AUTH_KEY, Constants.AUTH_SECRET);
    ...
    private void initQBRTCClient() {
        ...
        QBRTCClient.getInstance(IncomeCallListenerService.this).addSessionCallbacksListener(this);
       // QBRTCClient.getInstance(IncomeCallListenerService.this).addConnectionCallbacksListener(this);

        // Start mange QBRTCSessions according to VideoCall parser's callbacks
        QBRTCClient.getInstance(IncomeCallListenerService.this).prepareToProcessCalls(getApplicationContext());
    }
    ...
    public void onDestroy() {
        ...
        QBRTCClient.getInstance(IncomeCallListenerService.this).removeSessionsCallbacksListener(this);
        QBRTCClient.getInstance(IncomeCallListenerService.this).removeConnectionCallbacksListener((QBRTCSessionConnectionCallbacks) this);
...
//                        }
    ...
    private void sendBroadcastMessages(int callbackAction, Integer usedID,
                                       Map<String, String> userInfo, Exception exception) {
...
//
//    @Override
//    public void onError(QBRTCSession qbrtcSession, Exception e) {
